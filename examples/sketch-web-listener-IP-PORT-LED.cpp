...
bool connected = true;
static char agent_ip[32] = {"192.168.2.101"};
...
//    digitalWrite(PIN_LED1, !digitalRead(PIN_LED1));
    ...
    switch(topic.data[0])
    {
        case 'S': digitalWrite(PIN_LED1, 0);
                  digitalWrite(PIN_LED2, 0);
                  break;
        case 'F': digitalWrite(PIN_LED1, 1);
                  digitalWrite(PIN_LED2, 0);
                  break;
        case 'R': digitalWrite(PIN_LED1, 0);
                  digitalWrite(PIN_LED2, 1);
                  break;
        case 'B': digitalWrite(PIN_LED1, 1);
                  digitalWrite(PIN_LED2, 1);
                  break;
    }
}
